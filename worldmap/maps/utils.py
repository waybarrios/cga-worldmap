...
from worldmap.maps.models import Map, Layer, MapLayer, Contact, ContactRole, Role, get_csw
from worldmap.maps.gs_helpers import fixup_style, cascading_delete, get_sld_for, delete_from_postgis, get_postgis_bbox
import uuid
import os
import glob
import sys
...
from worldmap.maps.models import Contact, Layer, LayerAttribute
from worldmap.maps.gs_helpers import cascading_delete, get_sld_for, delete_from_postgis
...
logger = logging.getLogger("worldmap.maps.utils")
_separator = '\n' + ('-' * 100) + '\n'
import math
...
def create_django_record(user, title, keywords, abstract, gs_resource, permissions):
    ...
    if permissions is not None:
        from worldmap.maps.views import set_layer_permissions
    ...
    try:
        ...
        logger.exception('>>> FIXME: Please, if you can write python code, '
                         'implement "verify()" '
                         'method in worldmap.maps.models.Layer')
