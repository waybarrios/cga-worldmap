...
from worldmap.maps.owslib_csw import CatalogueServiceWeb
from geoserver.catalog import Catalog
from worldmap.core.models import PermissionLevelMixin
from worldmap.core.models import AUTHENTICATED_USERS, ANONYMOUS_USERS, CUSTOM_GROUP_USERS
from worldmap.geonetwork import Catalog as GeoNetwork
...
from worldmap.maps.gs_helpers import cascading_delete, get_postgis_bbox
import logging
from worldmap.maps.encode import num_encode
from django.core.cache import cache
import sys
import re
from worldmap.maps.encode import despam, XssCleaner
from worldmap.flexidates import FlexiDateField, FlexiDateFormField


logger = logging.getLogger("worldmap.maps.models")
...
class Layer(models.Model, PermissionLevelMixin):
    ...
    def layer_config(self, user):
        ...
        :method:`worldmap.maps.models.Map.viewer_json` for an example of
    ...
    def queue_gazetteer_update(self):
        from worldmap.queue.models import GazetteerUpdateJob
    ...
    def update_gazetteer(self):
        from worldmap.gazetteer.utils import add_to_gazetteer, delete_from_gazetteer
    ...
    def queue_bounds_update(self):
        from worldmap.queue.models import LayerBoundsUpdateJob
...
class MapLayer(models.Model):
    ...
    # see :class:`worldmap.maps.models.MapLayerManager`
    ...
    def layer_config(self, user):
        ...
        if self.name is not None and self.source_params.find( "gxp_gnsource") > -1:
            ...
            from worldmap.queue.tasks import loadHGL
