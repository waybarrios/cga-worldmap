...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maps_layer', 'service', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='services.Service', null=True, to=orm['services.Service']), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 27, 11, 15, 58, 887984)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 27, 11, 15, 58, 887921)'}),
        ...
        'maps.contact': {
            ...
            'member_expiration_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 27, 11, 15, 58, 805556)'}),
        ...
        'maps.layer': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'services.Service'", 'null': 'True', 'to': "orm['services.Service']"}),
