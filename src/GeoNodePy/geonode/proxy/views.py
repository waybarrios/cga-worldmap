...
def valid_response(responseContent):
    ...
    if responseContent[0] == "<":
        try:
            ...
            if re.match("\{http\:\/\/www\.opengis\.net\/wms\}WMS_Capabilities|WMT_MS_Capabilities|WMS_DescribeLayerResponse|\{http\:\/\/www\.opengis\.net\/gml\}FeatureCollection|msGMLOutput|\{http\:\/\/www.opengis\.net\/wfs\}FeatureCollection", et.tag):
                return responseContent
        except ParseError:
            return None
