...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Layer', fields ['typename']
        db.delete_unique('maps_layer', ['typename'])

        # Adding index on 'Layer', fields ['uuid']
        db.create_index('maps_layer', ['uuid'])


    def backwards(self, orm):
        
        # Removing index on 'Layer', fields ['uuid']
        db.delete_index('maps_layer', ['uuid'])

        # Adding unique constraint on 'Layer', fields ['typename']
        db.create_unique('maps_layer', ['typename'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 10, 13, 11, 25, 662673)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 10, 13, 11, 25, 662608)'}),
        ...
        'maps.contact': {
            ...
            'member_expiration_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 10, 13, 11, 25, 534565)'}),
